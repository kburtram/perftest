...
export const OBS_CONTRACT: Registry = {
    ...
    "metrics": [
        ...
        },
        {
            ...
            "feature": "tableDesigner",
            "derivedFrom": [
                "mssql.tableDesigner.init.begin",
                "mssql.tableDesigner.init.end"
            ]
        },
        {
            ...
            "feature": "schemaDesigner",
            "derivedFrom": [
                "mssql.schemaDesigner.init.begin",
                "mssql.schemaDesigner.init.end"
            ]
        },
        {
        ...
        },
        {
            ...
            "feature": "queryResults",
            "derivedFrom": [
                "mssql.queryResults.pin.open.begin",
                "mssql.queryResults.pin.open.end"
            ]
        },
        {
        ...
        },
        {
            ...
            "derivedFrom": [
                "mssql.queryResults.pin.open.begin",
                "mssql.queryResults.pin.rendered"
            ]
        },
        {
        ...
        },
        {
            ...
            "feature": "runbookStudio",
            "derivedFrom": [
                "mssql.runbookStudio.open.begin",
                "mssql.runbookStudio.open.end"
            ]
        },
        {
            ...
            "feature": "runbookStudio",
            "derivedFrom": [
                "mssql.runbookStudio.bind.begin",
        ...
        },
        {
            ...
            "feature": "runbookStudio",
            "derivedFrom": [
                "mssql.runbookStudio.activity.begin",
                "mssql.runbookStudio.activity.end"
            ]
        },
        {
    ...
    "classifications": {
        "secret": {
            ...
            "defaultBehavior": "never stored, never displayed, never exported — regardless of capture mode"
        },
        "userSql": {
            "examples": [
                "SQL text",
            ...
            "defaultBehavior": "digest by default; plaintext only under governed elevated capture, local-only"
        },
        "resultData": {
            "examples": [
                "row cells",
        ...
        "providerText": {
            ...
            "defaultBehavior": "sanitized safe code/enum by default — provider messages can embed SQL text and values and get NO error-string loophole"
        },
        "identifierSensitive": {
            "examples": [
                "server/database/object names",
                "file paths"
            ],
    ...
    "timingClasses": {
        ...
        "epochAligned": {
            "meaning": "Endpoints aligned by wall clock across processes (e.g. STS spans in an extension-anchored waterfall).",
