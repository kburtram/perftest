...
| `mssql.queryStudio.tab.activation.begin` | webviewMark | begin | `mssql.queryStudio.tab.activation.end` | queryStudio | webview | epochAligned | no | from:safeEnum, to:safeEnum, source:safeEnum, mountedBefore:structuralMetadata … |
| `mssql.queryStudio.tab.activation.end` | webviewMark | end | `mssql.queryStudio.tab.activation.begin` | queryStudio | webview | epochAligned | no | from:safeEnum, to:safeEnum, source:safeEnum, mountedBefore:structuralMetadata, rafThrottled:structuralMetadata … |
